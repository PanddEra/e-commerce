import NewsletterForm from "@layouts/Footer/NewsletterForm";
    ...
    return (<footer style={{width: "100%", backgroundColor: "#F0F0F0"}}>
        ...
        <Container sx={{display: "flex", justifyContent: "space-between", minWidth: "100%", alignItems: "center", gap: 10, mt: 5, mb: 5}}>
            <div style={{maxWidth: "250px", display: "flex", flexDirection: "column", gap: "35px"}}>
                ...
                <ul style={{display: "flex", gap: "10px", listStyle: "none", color: "black"}}>
            ...
            <div>
                <ul style={{listStyle: "none", display: "flex", flexDirection: "column", gap: "26px"}}>
                    <li><Typography sx={{fontWeight: 500, fontFamily: "Satoshi, sans-serif", fontSize: 16}}>COMPANY</Typography></li>
            ...
            <div>
                <ul style={{listStyle: "none", display: "flex", flexDirection: "column", gap: "26px"}}>
                    <li><Typography sx={{fontWeight: 500, fontFamily: "Satoshi, sans-serif", fontSize: 16}}>HELP</Typography></li>
            ...
            <div>
                <ul style={{listStyle: "none", display: "flex", flexDirection: "column", gap: "26px"}}>
                    <li><Typography sx={{fontWeight: 500, fontFamily: "Satoshi, sans-serif", fontSize: 16}}>FAQ</Typography></li>
            ...
            <div>
                <ul style={{listStyle: "none", display: "flex", flexDirection: "column", gap: "26px"}}>
                    <li><Typography sx={{fontWeight: 500, fontFamily: "Satoshi, sans-serif", fontSize: 16}}>RESOURCES</Typography></li>
        ...
        <Divider/>
            ...
            <ul style={{display: "flex", gap: "12px", listStyle: "none"}}>
                <li style={{border: "1px solid #eee", borderRadius: "5px", boxShadow: "0 2px 4px rgba(183, 183, 183, 0.08)"}}>
                    <svg width="50" height="30" viewBox="0 0 120 80" fill="none"
                ...
                <li style={{border: "1px solid #eee", borderRadius: "5px", boxShadow: "0 2px 4px rgba(183, 183, 183, 0.08)"}}>
                    <svg width="50" height="30" viewBox="0 0 120 80" fill="none"
                        ...
                        <path fillRule="evenodd" clipRule="evenodd"
                              ...
                              fill="#F79E1B"/>
                        <path fillRule="evenodd" clipRule="evenodd"
                              d="M49.6521 58.595H70.3479V21.4044H49.6521V58.595Z" fill="#FF5F00"/>
                        <path fillRule="evenodd" clipRule="evenodd"
